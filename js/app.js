(() => {
  ...
  */                var _suppressOverwrites, _reverting, _context, _globalTimeline, _win, _coreInitted, _doc, _coreReady, _lastRenderedFrame, _quickTween, _tickerActive, _config = {
    ...
    (() => {
        ...
        gsap.gsap.from("#logo-1", {
            opacity: 0,
            y: -30,
            duration: 1
        });
        gsap.gsap.from("#logo-2", {
            opacity: 0,
            y: 15,
            duration: 1
        });
        gsap.gsap.from("#logo-3-1", {
            opacity: 0,
            xPercent: 50,
            yPercent: 50,
            scale: 0,
        ...
        gsap.gsap.from("#logo-3-2", {
            opacity: 0,
            y: -20,
            duration: .5,
            delay: 1.4
        });
        gsap.gsap.from("#logo-4", {
            opacity: 0,
            xPercent: -10,
            y: -50,
            duration: 1,
        ...
        gsap.gsap.from("#logo-6", {
            opacity: 0,
            y: 15,
            duration: 1
        });
        gsap.gsap.from("#logo-7", {
            opacity: 0,
            y: -30,
            duration: 1
        });
        gsap.gsap.from("#logo-8", {
            opacity: 0,
            x: -30,
            duration: 1
        });
        gsap.gsap.from("#logo-9", {
            opacity: 0,
            xPercent: -40,
            yPercent: 0,
            scale: 0,
        ...
        gsap.gsap.from("#logo-11", {
            opacity: 0,
            x: 30,
            duration: 1
        });
        gsap.gsap.from("#logo-12", {
            opacity: 0,
            scale: 0,
        ...
        const logoSvgPath = document.querySelectorAll(".intro__logo path");
        let delay = .6;
        for (let i = 13; i < logoSvgPath.length; i++) {
            const path = logoSvgPath[i];
            const pathId = path.getAttribute("id");
            gsap.gsap.from(`#${pathId}`, {
                opacity: 0,
                duration: 1,
                delay
            });
